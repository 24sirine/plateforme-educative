...
$sql = "SELECT * FROM etudiant where Classe ='INFO3-B'";
...
<main role="main">
        <div class="jumbotron">
            <div class="container">
            <div class="swipe">
		<a ><div class="s-card"><p>LES ABSENCES DES ETUDIANTS DE INFO3-B</p></div></a>
            </div>
            </div>
          </div>
...
$sql1 = "SELECT * FROM absence where Classe ='INFO3-B'";
