...
$sql = "SELECT * FROM etudiant where Classe ='INFO1-E'";
...
<main role="main">
        <div class="jumbotron">
            <div class="container">
            <div class="swipe">
		<a ><div class="s-card"><p>LES ABSENCES DES ETUDIANTS DE INFO1-E</p></div></a>
            </div>
            </div>
          </div>
...
$sql1 = "SELECT * FROM absence where Classe ='INFO1-E'";
